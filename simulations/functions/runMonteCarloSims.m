function [V_sim, u_opt, p_sim, MFV, RLR, IVI, spillStats] = runMonteCarloSims(sysparams, bounds, std_hat, X, printplot, policyLabel)
    ...
    nSim  = 1000;                   % number of Monte Carlo runs
    tt    = (1:T)';
    ...
    for sIdx = 1:nSim
        ...
        for t = 1:T
            for i = 1:n
                ...
                V_i = V_prev(i) + inflow_i - u_opt(t,i) - s_opt(t,i);
                ...
                if V_i <= 0
                    ...
                    h_i = a(i) * (V_i^b(i));
                    p_i = u_opt(t,i) * h_i;    % (TEMP) multiply by c when rescaled
                end
    ...
    if printplot
        plotReservoirMCGrid(tt, V_opt, V_sim, Vmin, Vmax, bLabel, policyLabel);
    end
end


function plotReservoirMCGrid(tt, V_opt, V_sim, Vmin, Vmax, bLabel, policyLabel)
