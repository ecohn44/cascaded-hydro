    ...
    for i = 1:n
        ...
        plot(ax, t, Q(:, i), 'LineWidth', lw, 'Color', col);
            ...
            if i == 1
                ...
                % baseline flow
                q0 = max(Q(:,i));                     % baseline plateau
                yline(ax, q0, '--', 'Color',[0.85 0.1 0.1], 'LineWidth',2.0);
                ...
                % mark minimum point
                scatter(ax, tmin, Qmin, 60, [0.85 0.1 0.1], 'filled');
            
                % estimate drought start/end (below baseline)
                drought_idx = find(Q(:,i) < q0 - 10);
                t_start = drought_idx(1);
                ...
                % duration line
                plot(ax, [t_start t_end], [yD yD], 'k', 'LineWidth',2);
                
                % end caps
                plot(ax, [t_start t_start], [yD-cap yD+cap], 'k', 'LineWidth',2);
