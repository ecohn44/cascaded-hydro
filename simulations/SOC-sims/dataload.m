...
function [params, sysparams, scenarioparams] = dataload(n, N)
    ...
    scenarioparams(1).amp1         = 0.35;      % +% gain for pulse 1
    scenarioparams(1).amp2         = 0.35;      % +% gain for pulse 2
    scenarioparams(1).w1           = 8;        % first drought pulse lasts 8 hours
    scenarioparams(1).w2           = 8;        % second drought pulse lasts 4 hours
    scenarioparams(1).t0           = [0.3, 0.5];  % pulses at 30% and 50% of horizon
    ...
    scenarioparams(2).amp1         = 0.45;   % Magnitude of drought event %.15
    scenarioparams(2).nEvents      = 1;      % number of events
    scenarioparams(2).daysPerEvent = 2;      % drought length %.8
