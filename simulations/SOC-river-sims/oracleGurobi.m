    ...
    for t = 1:T
        for i = 1:n
            ...
            if t == 1
                ...
                % Power production via McCormick Envelopes: p(i,t) = c * a * v(i,t)^b * u(i,t)
                h_min = sys(i).min_h;
                h_max = sys(i).max_h;
                u_min = sys(i).min_ut;
                u_max = sys(i).max_ut;
