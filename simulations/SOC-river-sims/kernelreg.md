...
$$
\mathcal I_t=\{\max(1,t-W+1),\ldots,t\},
$$
...
\mathbf x_t=
\begin{bmatrix}
\operatorname{vec}(\tilde{\mathbf q}_{\mathcal I_t})\\
\operatorname{vec}(\mathbf v_{\mathcal I_t})
\end{bmatrix}.
$$
...
\mathbf y_{s,t}=
\begin{bmatrix}
\operatorname{vec}(\tilde{\mathbf q}^{(s)}_{\mathcal I_t})\\
\operatorname{vec}(\mathbf v^{*,(s)}_{\mathcal I_t})
\end{bmatrix}.
$$
